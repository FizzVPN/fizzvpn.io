...
1. **Подписка — это ссылка**, которую вы получаете, вида *https://get...*
	>***Переходить по ней и копирать содержимое оттуда не надо!***

2. Получение подписки может занимать **до 10 секунд.**

3. В случае, если вместо какого-то из серверов появилась надпись:  
